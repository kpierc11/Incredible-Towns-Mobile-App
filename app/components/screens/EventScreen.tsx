...
function Events() {
  ...
  const [carouselItems, setCarouselItems] = useState([
    <EventCard
      uri={"https://upload.wikimedia.org/wikipedia/commons/thumb/d/d1/Mount_Everest_as_seen_from_Drukair2_PLW_edit.jpg/1200px-Mount_Everest_as_seen_from_Drukair2_PLW_edit.jpg"}
